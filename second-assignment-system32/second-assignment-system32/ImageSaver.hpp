...
public:
    ...
    static void saveImage1(const TinyImageJM& image1, T1& tree1, const string& baseFilename);

    // Save image 2 based on image2 size, all pixels from T1
    static void saveImage2(const TinyImageJM& image2, T1& tree1, const string& baseFilename);

    // Save image 3 based on image2 size, all pixels from T2
    static void saveImage3(const TinyImageJM& image2, T2& tree2, const string& baseFilename);
